...
const projects = [
  {
    ...
    description:
      "An AI-powered travel planner that generates personalized itineraries using natural language input. Features real-time data, smart booking links, and a modern animated UI.",
    ...
    githubUrl:
      "https://github.com/Mighty-Sarthak-07/SkyTrip---AI-powered-trip-planner",
  ...
  },
  {
    ...
    description:
      "A beautiful landing page app using React, GSAP and Tailwind. Featuring scroll-triggered animations, immersive visuals, and a cinematic feel inspired by the Solo Leveling universe.",
    ...
    videoUrl:
      "https://www.instagram.com/reel/DG8q57aTwWM/?igsh=bWtuZWloejN6eWU0",
    type: "webapp",
  },
  {
    id: 3,
    ...
    videoUrl: null,
    linkedinEmbed:
      "https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7345531500999688192?compact=1",
    type: "webapp",
  },
  {
    id: 4,
    ...
    videoUrl: null,
    linkedinEmbed:
      "https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7358575237900193794?compact=1",
    type: "webapp",
  },
  {
    id: 5,
    ...
    description:
      "Developed a high-end scrollytelling product website for a beverage brand featuring immersive canvas-based animations and seamless UI transitions. Implemented scroll-controlled image sequence rendering using HTML5 Canvas for a cinematic 3D experience. Built dynamic product switching with real-time state updates, adaptive background gradients, and smooth animations using Framer Motion. Optimized performance with requestAnimationFrame and preloaded assets for a consistent 60fps experience.",
  ...
  },
  {
    ...
    description:
      "Developed a high-performance SpaceX-inspired landing experience using React and Tailwind CSS, featuring parallax scrolling, smooth transitions, and immersive UI animations. Implemented responsive layouts, optimized asset loading, and scroll-triggered effects to deliver a cinematic, modern web experience. Focused on performance, visual hierarchy, and interactive storytelling design.",
  ...
  },
  {
    ...
    title: "UrbanNext",
    description:
      "UrbanNext is a modern and intuitive user interface designed for seamless real estate experiences. Whether you're looking to buy or sell plots, houses, or flats, UrbanNext provides a user-friendly platform with clean design and smooth navigation.",
    image: "/projects/project4.png",
    tags: ["UI/UX", "Figma"],
    demoUrl:
      "https://www.figma.com/design/Ziq5KOmwHWtWcizxxWL31t/UrbanNest--for-Selling-houses-plot-and-flats?node-id=0-1&t=FlfUDC69e1xC1fVS-1",
    githubUrl: null,
    videoUrl: null,
    type: "uiux",
  },
...
const filterButtons = [
  ...
  },
  {
    ...
    value: "webapp",
    activeClass:
      "bg-gradient-to-r from-yellow-400 via-pink-500 to-red-500 text-white shadow-lg",
  },
  {
    label: "UI / UX",
    value: "uiux",
...
export const ProjectsSection = () => {
  ...
  return (
    <>
      <section
        id="projects"
        className="py-28 px-4 relative bg-muted/30 overflow-hidden"
      >
        <motion.div
          initial={{ opacity: 0 }}
            ...
            >
              {filteredProjects.map((project) => (
                <motion.div
                  ...
                  whileHover={{
                    scale: 1.04,
                    boxShadow: "0 12px 40px rgba(80,0,200,0.14)",
                  }}
                  whileTap={{ scale: 0.98 }}
                ...
                >
                  ...
                  <div className="h-48 overflow-hidden relative z-10">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/65 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20 flex flex-col justify-end p-4">
                      <h3 className="text-base font-bold text-white mb-0.5 drop-shadow-lg line-clamp-1">
                        {project.title}
                      </h3>
                  ...
                  <div className="p-5 relative z-10">
                    ...
                    <h3 className="text-lg font-bold mb-1 text-primary line-clamp-1">
                      {project.title}
                    </h3>
