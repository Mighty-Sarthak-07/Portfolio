...
const projects = [
  ...
  },
  {
    ...
    title: "Podcreator",
    description:
      "PodCreator is a full-stack podcast web application built using React, Express.js, and MongoDB. It allows users to upload, manage, and listen to audio podcasts anytime, anywhere.",
